  ...
  return (
    <section className="h-auto bg-white bg-[url('/pages/contact.webp')] relative">
      ...
      <div className="size-full py-2 sm:py-10 z-70 relative">
        ...
        <div className="py-10 px-2 sm:px-5 lg:px-10 flex flex-end sm:flex-row justify-center max-w-[60rem] h-auto mx-5 lg:mx-auto rounded-xl mb-20 md:rounded-[2.75rem] bg-duo-dark">
          <div
          ...
          >
            ...
            >
              ...
              <div id="contact-icon" className="flex items-center justify-between">
